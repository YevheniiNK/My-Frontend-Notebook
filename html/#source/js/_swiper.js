...
let myImageSlider = new Swiper('.image-slider', {
	...
	pagination: {
		...
		// Выбрать тип пагинации
			type: 'fraction',


		/*
		// Буллеты (Разрешает кликать по булетам и менять слайды) подключаем в "pagination"
		type: 'bullets',
		clickable: true,

		// Динамические буллеты (Точки будут изменять свой размер) подключаем в "pagination"
		dynamicBullets: true,

		// Кастомные буллеты (Внутри точек будут отображаться номера слайда) подключаем в "pagination"
